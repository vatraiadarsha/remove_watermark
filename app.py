...
def remove_watermark(input_pdf, output_pdf, watermark_text):
    ...
    for page_number in range(len(pdf_document)):
        ...
        for inst in text_instances:
            ...
            rect = inst.irect  # Use inst.irect instead of inst.rect
            page.draw_rect(rect, fill=(1, 1, 1))  # Use draw_rect instead of drawRect
    
    pdf_document.save(output_pdf)
    pdf_document.close()

if __name__ == "__main__":
    input_pdf_file = "input.pdf"  # Replace with your input PDF file
